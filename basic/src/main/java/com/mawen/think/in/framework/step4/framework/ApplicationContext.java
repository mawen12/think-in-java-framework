package com.mawen.think.in.framework.step4.framework;
...
import com.mawen.think.in.framework.step4.framework.exception.FrameworkException;
...
public class ApplicationContext {
	...
	private <T> Constructor<T> findConstructor(Class<T> clazz) {
		...
		return constructorsWithAnnotation.stream()
				.findFirst()
				.orElseThrow(() -> new FrameworkException("The is no constructor with Autowired annotation: " + clazz.getName()));
	}
